...
**This is a short walk-through of useful utilities in sidpy.proc.comp_utils. that simplify common computational
tasks.**
...
try:
    ...
    print('sidpy not found.  Will install with pip.')
    import pip
    install('sidpy')
    from sidpy.proc import comp_utils
